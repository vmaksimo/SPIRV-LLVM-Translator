...
entry:
  ...
  %call.i = tail call spir_func i32 @_Z9get_fencePU3AS4v(ptr addrspace(4) addrspacecast (ptr addrspace(1) @gint to ptr addrspace(4))) #3
  %switch.i.i = icmp ult i32 %call.i, 4
  %1 = load i32, ptr addrspace(4) addrspacecast (ptr addrspace(1) @gint to ptr addrspace(4)), align 4
  ...
  store i32 %cond, ptr addrspace(1) %arrayidx, align 4
  ret void
}
