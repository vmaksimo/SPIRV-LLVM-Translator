...
define spir_kernel void @test(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 1) %img) #0 !kernel_arg_addr_space !1 !kernel_arg_access_qual !2 !kernel_arg_type !3 !kernel_arg_base_type !4 !kernel_arg_type_qual !5 {
entry:
  ret void
}
