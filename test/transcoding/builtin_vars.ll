...
; RUN: spirv-val %t.spv
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r %t.spv -o %t.out.bc
; RUN: llvm-dis %t.out.bc -o - | FileCheck %s --check-prefix=CHECK-OCL-IR
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r %t.spv --spirv-target-env=SPV-IR -o %t.out.bc
...
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -spirv-text %t.out.bc -o - | FileCheck %s --check-prefix=CHECK-SPIRV
