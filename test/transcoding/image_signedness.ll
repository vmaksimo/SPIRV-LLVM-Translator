...
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r --spirv-target-env=SPV-IR %t.spv -o %t.rev.bc
...
entry:
  ...
  store <4 x i32> %call, ptr addrspace(1) %res, align 16, !tbaa !9
  %call1 = tail call spir_func <4 x i32> @_Z11read_imagei14ocl_image1d_ro11ocl_sampleri(ptr addrspace(1) %im, ptr addrspace(2) %0, i32 43) #3
  store <4 x i32> %call1, ptr addrspace(1) %resu, align 16, !tbaa !9
  %call2 = tail call spir_func <4 x i32> @_Z12read_imageui20ocl_image1d_array_rwDv2_i(ptr addrspace(1) %ima, <2 x i32> undef) #3
  store <4 x i32> %call2, ptr addrspace(1) %resu, align 16, !tbaa !9
  %call3 = tail call spir_func <4 x i32> @_Z12read_imageui14ocl_image1d_roi(ptr addrspace(1) %im, i32 44) #3
  store <4 x i32> %call3, ptr addrspace(1) %res, align 16, !tbaa !9
  %call4 = tail call spir_func <4 x i32> @_Z11read_imagei14ocl_image1d_roi(ptr addrspace(1) %im, i32 45) #3
  store <4 x i32> %call4, ptr addrspace(1) %resu, align 16, !tbaa !9
  ret void
}
...
define spir_kernel void @imagewrites(i32 %offset, ptr addrspace(1) nocapture readonly %input, ptr addrspace(1) nocapture readonly %inputu, ptr addrspace(1) %output) local_unnamed_addr #0 !kernel_arg_addr_space !14 !kernel_arg_access_qual !15 !kernel_arg_type !16 !kernel_arg_base_type !17 !kernel_arg_type_qual !18 !kernel_arg_name !19 !kernel_attributes !20 {
  ...
  tail call void @_Z12write_imagei14ocl_image2d_woDv2_iDv4_i(ptr addrspace(1) %output, <2 x i32> <i32 11, i32 11>, <4 x i32> %0) #3
  %arrayidx3 = getelementptr inbounds <4 x i32>, ptr addrspace(1) %inputu, i64 %idxprom
  %1 = load <4 x i32>, ptr addrspace(1) %arrayidx3, align 16
  tail call void @_Z13write_imageui14ocl_image2d_woDv2_iDv4_j(ptr addrspace(1) %output, <2 x i32> <i32 22, i32 22>, <4 x i32> %1) #3
  ret void
}

declare dso_local ptr addrspace(2) @__translate_sampler_initializer(i32) local_unnamed_addr

; Function Attrs: convergent nounwind readonly
declare dso_local spir_func <4 x i32> @_Z12read_imageui14ocl_image1d_ro11ocl_sampleri(ptr addrspace(1), ptr addrspace(2), i32) local_unnamed_addr #1

; Function Attrs: convergent nounwind readonly
declare dso_local spir_func <4 x i32> @_Z11read_imagei14ocl_image1d_ro11ocl_sampleri(ptr addrspace(1), ptr addrspace(2), i32) local_unnamed_addr #1

; Function Attrs: alwaysinline convergent nounwind readonly
declare <4 x i32> @_Z12read_imageui14ocl_image1d_roi(ptr addrspace(1), i32) local_unnamed_addr #1

; Function Attrs: alwaysinline convergent nounwind readonly
declare <4 x i32> @_Z11read_imagei14ocl_image1d_roi(ptr addrspace(1), i32) local_unnamed_addr #1

; Function Attrs: alwaysinline convergent nounwind readonly
declare <4 x i32> @_Z12read_imageui20ocl_image1d_array_rwDv2_i(ptr addrspace(1), <2 x i32>) local_unnamed_addr #1

; Function Attrs: alwaysinline convergent
declare void @_Z12write_imagei14ocl_image2d_woDv2_iDv4_i(ptr addrspace(1), <2 x i32>, <4 x i32>) local_unnamed_addr

; Function Attrs: alwaysinline convergent
declare void @_Z13write_imageui14ocl_image2d_woDv2_iDv4_j(ptr addrspace(1), <2 x i32>, <4 x i32>) local_unnamed_addr
...
!5 = !{!"read_only", !"read_write", !"none", !"none"}
!6 = !{!"image1d_t", !"image1d_array_t", !"uint4*", !"uint4*"}
!7 = !{!"image1d_t", !"image1d_array_t", !"uint __attribute__((ext_vector_type(4)))*", !"uint __attribute__((ext_vector_type(4)))*"}
!8 = !{!"", !"", !"", !""}
!9 = !{!10, !10, i64 0}
