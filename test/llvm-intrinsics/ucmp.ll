...
; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI8Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI8Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI16Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI16Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI32Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI32Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI64Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI64Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeVBool]] [[#CmpV4I8Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeVBool]] [[#CmpV4I8Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeVBool]] [[#CmpV4I16Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeVBool]] [[#CmpV4I16Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeVBool]] [[#CmpV4I32Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeVBool]] [[#CmpV4I32Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeVBool]] [[#CmpV4I64Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeVBool]] [[#CmpV4I64Res2:]] [[#]] [[#]]
...
; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI16I8Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI16I8Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i16 -1, 2) i16 @compare_i16i8(i8 noundef %0, i8 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i16 @llvm.ucmp.i16.i8(i8 %0, i8 %1)
  ret i16 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI32I8Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI32I8Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i32 -1, 2) i32 @compare_i32i8(i8 noundef %0, i8 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @llvm.ucmp.i32.i8(i8 %0, i8 %1)
  ret i32 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI64I8Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI64I8Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i64 -1, 2) i64 @compare_i64i8(i8 noundef %0, i8 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i64 @llvm.ucmp.i64.i8(i8 %0, i8 %1)
  ret i64 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI8I16Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI8I16Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i8 -1, 2) i8 @compare_i8i16(i16 noundef %0, i16 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i8 @llvm.ucmp.i8.i16(i16 %0, i16 %1)
  ret i8 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI32I16Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI32I16Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i32 -1, 2) i32 @compare_i32i16(i16 noundef %0, i16 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @llvm.ucmp.i32.i16(i16 %0, i16 %1)
  ret i32 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI64I16Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI64I16Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i64 -1, 2) i64 @compare_i64i16(i16 noundef %0, i16 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i64 @llvm.ucmp.i64.i16(i16 %0, i16 %1)
  ret i64 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI8I32Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI8I32Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i8 -1, 2) i8 @compare_i8i32(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i8 @llvm.ucmp.i8.i32(i32 %0, i32 %1)
  ret i8 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI16I32Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI16I32Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i16 -1, 2) i16 @compare_i16i32(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i16 @llvm.ucmp.i16.i32(i32 %0, i32 %1)
  ret i16 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI64I32Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI64I32Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i64 -1, 2) i64 @compare_i64i32(i32 noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i64 @llvm.ucmp.i64.i32(i32 %0, i32 %1)
  ret i64 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI8I64Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI8I64Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i8 -1, 2) i8 @compare_i8i64(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i8 @llvm.ucmp.i8.i64(i64 %0, i64 %1)
  ret i8 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI16I64Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI16I64Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i16 -1, 2) i16 @compare_i16i64(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i16 @llvm.ucmp.i16.i64(i64 %0, i64 %1)
  ret i16 %3
}

; CHECK-SPIRV: ULessThanEqual [[#TypeBool]] [[#CmpI32I64Res1:]] [[#]] [[#]]
; CHECK-SPIRV: ULessThan [[#TypeBool]] [[#CmpI32I64Res2:]] [[#]] [[#]]
...
define dso_local noundef range(i32 -1, 2) i32 @compare_i32i64(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @llvm.ucmp.i32.i64(i64 %0, i64 %1)
  ret i32 %3
}

; Res type equal to arg type, scalar.
declare i8 @llvm.ucmp.i8.i8(i8, i8) #1
declare i16 @llvm.ucmp.i16.i16(i16, i16) #1
declare i32 @llvm.ucmp.i32.i32(i32, i32) #1
declare i64 @llvm.ucmp.i64.i64(i64, i64) #1

; Res type equal to arg type, array.
declare <4 x i8> @llvm.ucmp.v4i8.v4i8(<4 x i8>, <4 x i8>) #1
declare <4 x i16> @llvm.ucmp.v4i16.v4i16(<4 x i16>, <4 x i16>) #1
declare <4 x i32> @llvm.ucmp.v4i32.v4i32(<4 x i32>, <4 x i32>) #1
declare <4 x i64> @llvm.ucmp.v4i64.v4i64(<4 x i64>, <4 x i64>) #1

; Res type different than arg type, scalar.
declare i16 @llvm.ucmp.i16.i8(i8, i8) #1
declare i32 @llvm.ucmp.i32.i8(i8, i8) #1
declare i64 @llvm.ucmp.i64.i8(i8, i8) #1
declare i8 @llvm.ucmp.i8.i16(i16, i16) #1
declare i32 @llvm.ucmp.i32.i16(i16, i16) #1
declare i64 @llvm.ucmp.i64.i16(i16, i16) #1
declare i8 @llvm.ucmp.i8.i32(i32, i32) #1
declare i16 @llvm.ucmp.i16.i32(i32, i32) #1
declare i64 @llvm.ucmp.i64.i32(i32, i32) #1
declare i8 @llvm.ucmp.i8.i64(i64, i64) #1
declare i16 @llvm.ucmp.i16.i64(i64, i64) #1
