...
define dso_local spir_func float @_Z14AtomicFloatMinRf(ptr addrspace(4) align 4 dereferenceable(4) %Arg) local_unnamed_addr #0 {
entry:
  ...
  %call.i.i.i = tail call spir_func float @_Z21__spirv_AtomicFMinEXTPU3AS1fN5__spv5Scope4FlagENS1_19MemorySemanticsMask4FlagEf(ptr addrspace(1) %0, i32 1, i32 896, float 1.000000e+00) #2
  ret float %call.i.i.i
}

; Function Attrs: convergent
declare dso_local spir_func float @_Z21__spirv_AtomicFMinEXTPU3AS1fN5__spv5Scope4FlagENS1_19MemorySemanticsMask4FlagEf(ptr addrspace(1), i32, i32, float) local_unnamed_addr #1
; CHECK-LLVM-SPV: declare {{.*}}spir_func float @[[FLOAT_FUNC_NAME]]({{.*}}float

; Function Attrs: convergent norecurse nounwind
define dso_local spir_func double @_Z15AtomicDoubleMinRd(ptr addrspace(4) align 8 dereferenceable(8) %Arg) local_unnamed_addr #0 {
entry:
  %0 = addrspacecast ptr addrspace(4) %Arg to ptr addrspace(1)
  ...
  %call.i.i.i = tail call spir_func double @_Z21__spirv_AtomicFMinEXTPU3AS1dN5__spv5Scope4FlagENS1_19MemorySemanticsMask4FlagEd(ptr addrspace(1) %0, i32 1, i32 896, double 1.000000e+00) #2
  ret double %call.i.i.i
}

; Function Attrs: convergent
declare dso_local spir_func double @_Z21__spirv_AtomicFMinEXTPU3AS1dN5__spv5Scope4FlagENS1_19MemorySemanticsMask4FlagEd(ptr addrspace(1), i32, i32, double) local_unnamed_addr #1
