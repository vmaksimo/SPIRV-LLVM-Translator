...
// RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers --spirv-ext=+SPV_EXT_image_raw10_raw12 %t.bc -o %t.spv
// RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers --spirv-ext=+SPV_EXT_image_raw10_raw12 %t.spv -to-text -o %t.spt
...
// RUN: not llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers --spirv-ext=-SPV_EXT_image_raw10_raw12 %t.bc -o %t.spv 2>&1 | FileCheck %s --check-prefix=CHECK-EXT-OFF
