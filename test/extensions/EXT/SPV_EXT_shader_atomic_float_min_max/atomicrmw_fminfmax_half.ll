...
; CHECK: AtomicFMinEXT [[Half]] {{[0-9]+}} [[HalfPointer]] [[Scope_Workgroup]] [[MemSem_SequentiallyConsistent]] [[HalfValue]]
 %1 = atomicrmw fmax ptr addrspace(1) @f, half 42.000000e+00 seq_cst
; CHECK: AtomicFMaxEXT [[Half]] {{[0-9]+}} [[HalfPointer]] [[Scope_Workgroup]] [[MemSem_SequentiallyConsistent]] [[HalfValue]]
