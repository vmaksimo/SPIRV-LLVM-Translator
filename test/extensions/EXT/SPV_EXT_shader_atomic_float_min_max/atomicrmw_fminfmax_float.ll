...
; CHECK: AtomicFMinEXT [[Float]] {{[0-9]+}} [[FPPointer]] [[Scope_Workgroup]] [[MemSem_SequentiallyConsistent]] [[FPValue]]
 %1 = atomicrmw fmax ptr addrspace(1) @f, float 42.000000e+00 seq_cst
; CHECK: AtomicFMaxEXT [[Float]] {{[0-9]+}} [[FPPointer]] [[Scope_Workgroup]] [[MemSem_SequentiallyConsistent]] [[FPValue]]
