...
; CHECK-DAG: Constant [[Int]] [[Scope_Workgroup:[0-9]+]] 2 {{$}}
...
; CHECK: AtomicFMinEXT [[Double]] {{[0-9]+}} [[DoublePointer]] [[Scope_Workgroup]] [[MemSem_SequentiallyConsistent]] [[DoubleValue]]
 %1 = atomicrmw fmax ptr addrspace(1) @f, double 42.000000e+00 seq_cst
; CHECK: AtomicFMaxEXT [[Double]] {{[0-9]+}} [[DoublePointer]] [[Scope_Workgroup]] [[MemSem_SequentiallyConsistent]] [[DoubleValue]]
