...
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.bc -o %t.spt -spirv-text -spirv-ext=+SPV_INTEL_function_pointers
; RUN: FileCheck < %t.spt %s --check-prefix CHECK-SPIRV

; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.spt -o %t.spv -to-binary
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r -spirv-emit-function-ptr-addr-space %t.spv -o %t.rev.bc
