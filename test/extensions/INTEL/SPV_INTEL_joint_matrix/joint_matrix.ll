...
; CHECK-SPIRV: JointMatrixLoadINTEL [[#MatTy2]]
; CHECK-SPIRV: JointMatrixLoadINTEL [[#MatTy3]]
; CHECK-SPIRV: JointMatrixMadINTEL [[#MatTy1]]
; CHECK-SPIRV: JointMatrixStoreINTEL

; CHECK-LLVM: call spir_func target("spirv.JointMatrixINTEL", i32, 12, 12, 3, 3, 2) @_Z26__spirv_CompositeConstructi(i32 0)
; CHECK-LLVM: call spir_func target("spirv.JointMatrixINTEL", i8, 12, 48, 0, 3, 0) @_Z80__spirv_JointMatrixLoadINTEL_RPU3AS142__spirv_JointMatrixINTEL__char_12_48_0_3_0PU3AS4cliii
; CHECK-LLVM: call spir_func target("spirv.JointMatrixINTEL", i8, 48, 12, 2, 3, 1) @_Z80__spirv_JointMatrixLoadINTEL_RPU3AS142__spirv_JointMatrixINTEL__char_48_12_2_3_1PU3AS4cliii
...
; CHECK-LLVM: call spir_func void @_Z29__spirv_JointMatrixStoreINTELPU3AS4iPU3AS142__spirv_JointMatrixINTEL__uint_12_12_3_3_2liii(ptr addrspace(4) %call.ascast.i.i, target("spirv.JointMatrixINTEL", i32, 12, 12, 3, 3, 2)
