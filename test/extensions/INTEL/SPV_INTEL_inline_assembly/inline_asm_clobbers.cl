...
// CHECK-LLVM-NEXT: load ptr addrspace(1), ptr
...
// CHECK-LLVM: store i32 [[STOREVAL]], ptr [[VALUE]], align 4
...
// XCHECK-LLVM-NEXT: [[VALUE:%[a-z0-9]+]] = load i32, ptr [[LOADVAL]], align 4
// XCHECK-LLVM-NEXT: call void asm sideeffect "earlyclobber_instruction_in $0", "&r"(i32 [[VALUE]])
// XCHECK-LLVM: %{{[a-z0-9]+}} = load i32, ptr [[LOADVAL]], align 4
