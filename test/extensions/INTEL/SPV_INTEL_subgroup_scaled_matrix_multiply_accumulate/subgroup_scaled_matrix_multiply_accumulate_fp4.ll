; fp4 matrix sources require the sub-extension SPV_INTEL_subgroup_matrix_multiply_accumulate_float4
...
; Without the float4 sub-extension, translation must fail.
