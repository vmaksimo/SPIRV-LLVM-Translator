...
; CHECK-ERROR-NEXT: ClusterMode valid values are -1, 0, 1
...
entry:
  ...
  %call.i1 = call spir_func noundef target("spirv.TaskSequenceINTEL") @_Z31__spirv_TaskSequenceCreateINTEL(ptr noundef nonnull @_Z4multii, i32 noundef 10, i32 noundef 2, i32 noundef 17, i16 noundef zeroext 1) #3
