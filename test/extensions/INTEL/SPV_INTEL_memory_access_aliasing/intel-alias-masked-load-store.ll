...
; CHECK-LLVM: call spir_func i32 @wrappedload{{.*}} !alias.scope ![[LISTMD1]]{{.*}} ![[LISTMD2:[0-9]+]]
  %3 = call i32 @wrappedload(ptr addrspace(4) %0), !tbaa !5, !alias.scope !9
  %4 = call i32 @wrappedload(ptr addrspace(4) %1), !tbaa !5, !alias.scope !9, !noalias !16
  %add.i = add nsw i32 %4, %3
; CHECK-LLVM: call spir_func void @wrappedstore{{.*}} !noalias ![[LISTMD1]]
  call void @wrappedstore(i32 %add.i, ptr addrspace(4) %2),!tbaa !5, !noalias !9
  ret void
}
...
; CHECK-LLVM: call spir_func i32 @wrappedload{{.*}} !alias.scope ![[LISTMD3]]
  %3 = call i32 @wrappedload(ptr addrspace(4) %0), !tbaa !5, !alias.scope !13
  %4 = call i32 @wrappedload(ptr addrspace(4) %1), !tbaa !5, !alias.scope !13
  %add.i = add i32 %3, %_arg_5
  %add3.i = add i32 %add.i, %4
; CHECK-LLVM: call spir_func void @wrappedstore{{.*}} !noalias ![[LISTMD3]]
  call void @wrappedstore(i32 %add3.i, ptr addrspace(4) %2),!tbaa !5, !noalias !13
  ret void
}

; Function Attrs: norecurse nounwind readnone
define dso_local spir_func i32 @wrappedload(ptr addrspace(4) %0) local_unnamed_addr #2 {
entry:
...
; Function Attrs: norecurse nounwind readnone
define dso_local spir_func void @wrappedstore(i32 %0, ptr addrspace(4) %1) local_unnamed_addr #2 {
entry:
