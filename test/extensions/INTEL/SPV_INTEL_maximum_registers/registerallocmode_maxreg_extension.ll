...
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -spirv-text --spirv-ext=+SPV_INTEL_maximum_registers %t.bc
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.bc --spirv-ext=+SPV_INTEL_maximum_registers -o %t.spv
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r %t.spv -spirv-target-env=SPV-IR -o - | llvm-dis -o %t.rev.ll
