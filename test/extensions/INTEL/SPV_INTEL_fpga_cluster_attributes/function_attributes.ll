...
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers --spirv-ext=+SPV_INTEL_fpga_cluster_attributes %t.bc -o %t.spv
; RUN: spirv-val %t.spv
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r --spirv-ext=+SPV_INTEL_fpga_cluster_attributes %t.spv -o %t.rev.bc
