...
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.bc -o %t.spv --spirv-ext=+SPV_INTEL_complex_float_mul_div
; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.spv -o %t.spt --to-text

; RUN: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.spv -o %t.rev.bc -r
