; This is a copy of typed test/transcoding/OpGroupAsyncCopy.ll

; RUN: llvm-spirv %s --spirv-ext=+SPV_KHR_untyped_pointers -o %t.spv
; R/UN: spirv-dis %t.spv -o %t.spvasm
; R/UN: spirv-val %t.spv
; RUN: llvm-spirv %s --spirv-ext=+SPV_KHR_untyped_pointers -spirv-text -o %t.txt
...
;                                                        _Z29async_work_group_strided_copyPU3AS1hPU3AS3Khjj9ocl_event
...
; CHECK-SPIRV: UntypedGroupAsyncCopyKHR [[#]] [[#]] [[#Scope]]
