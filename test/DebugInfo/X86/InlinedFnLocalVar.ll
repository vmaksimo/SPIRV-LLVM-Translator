...
; RUNx: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.bc -o %t.spv --spirv-debug-info-version=nonsemantic-shader-100
; RUNx: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r %t.spv -o - | llvm-dis -o %t.ll
; RUNx: llc -mtriple i686-pc-cygwin -O2 %t.ll -o - | FileCheck %s

; RUNx: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers %t.bc -o %t.spv --spirv-debug-info-version=nonsemantic-shader-200
; RUNx: llvm-spirv --spirv-ext=+SPV_KHR_untyped_pointers -r %t.spv -o - | llvm-dis -o %t.ll
; RUNx: llc -mtriple i686-pc-cygwin -O2 %t.ll -o - | FileCheck %s
