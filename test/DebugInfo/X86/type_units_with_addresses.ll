...
@a = addrspace(1) global %struct.S1 zeroinitializer, align 1, !dbg !4
@s2 = addrspace(1) global %struct.S2 zeroinitializer, align 1, !dbg !11
@s3 = addrspace(1) global %struct.S3 zeroinitializer, align 1, !dbg !17
@s4 = addrspace(1) global %struct.S4 zeroinitializer, align 1, !dbg !25
...
!7 = !{}
!8 = !{!9}
!9 = !DITemplateValueParameter(name: "I", type: !10, value: ptr addrspace(1) @i)
...
!33 = !{!34}
!34 = !DITemplateValueParameter(name: "T", type: !10, value: ptr addrspace(1) @i)
