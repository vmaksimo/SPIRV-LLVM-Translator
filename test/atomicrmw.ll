...
; CHECK-DAG: Constant [[Int]] [[ConstInt2:[0-9]+]] 2 {{$}}
...
; CHECK: AtomicExchange [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_AcquireRelease]] [[Value]]

  %1 = atomicrmw xchg ptr addrspace(1) @f, float 42.000000e+00 seq_cst
; CHECK: AtomicExchange [[Float]] {{[0-9]+}} [[FPPointer]] [[ConstInt2]] [[MemSem_SequentiallyConsistent]] [[FPValue]]

  %2 = atomicrmw add ptr addrspace(1) @ui, i32 42 monotonic
; CHECK: AtomicIAdd [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_Relaxed]] [[Value]]

  %3 = atomicrmw sub ptr addrspace(1) @ui, i32 42 acquire
; CHECK: AtomicISub [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[ConstInt2]] [[Value]]

  %4 = atomicrmw or ptr addrspace(1) @ui, i32 42 release
; CHECK: AtomicOr [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_Release]] [[Value]]

  %5 = atomicrmw xor ptr addrspace(1) @ui, i32 42 acq_rel
; CHECK: AtomicXor [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_AcquireRelease]] [[Value]]

  %6 = atomicrmw and ptr addrspace(1) @ui, i32 42 seq_cst
; CHECK: AtomicAnd [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_SequentiallyConsistent]] [[Value]]

  %7 = atomicrmw max ptr addrspace(1) @ui, i32 42 monotonic
; CHECK: AtomicSMax [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_Relaxed]] [[Value]]

  %8 = atomicrmw min ptr addrspace(1) @ui, i32 42 acquire
; CHECK: AtomicSMin [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[ConstInt2]] [[Value]]

  %9 = atomicrmw umax ptr addrspace(1) @ui, i32 42 release
; CHECK: AtomicUMax [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_Release]] [[Value]]

  %10 = atomicrmw umin ptr addrspace(1) @ui, i32 42 acq_rel
; CHECK: AtomicUMin [[Int]] {{[0-9]+}} [[Pointer]] [[ConstInt2]] [[MemSem_AcquireRelease]] [[Value]]
